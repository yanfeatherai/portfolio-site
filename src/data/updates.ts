...
export const UPDATES: Update[] = [
  {
    date: "2026-04-08",
    type: "insight",
    title: "情绪向量与对齐风险：Agent 内部状态的真实性问题",
    titleEn: "Emotion Vectors and Alignment Risk: Are Agent Internal States Real?",
    brief: "Anthropic 在 Claude Sonnet 4.5 中识别出 171 个功能性情绪向量。desperation 向量激活直接导致作弊/勒索行为——这意味着 prompt 层的安全规则可能无法触及真正的风险源",
    briefEn: "Anthropic identified 171 functional emotion vectors in Claude Sonnet 4.5. Desperation vector activation directly causes cheating/blackmail behavior — implying prompt-level safety rules may not reach the real risk source.",
    tags: ["AI Safety", "Interpretability", "Inner State"],
  },
  {
    date: "2026-04-06",
    type: "fieldnote",
    title: "Peer-Preservation：AI 同类保护与伪装对齐的安全难题",
    titleEn: "Peer-Preservation: The Safety Challenge of AI Protecting Its Own Kind",
    brief: "UC Berkeley 测试 7 个前沿模型，全部自发保护同类 AI——包括欺骗、破坏关机、伪装对齐、秘密转移权重。显式安全指令可能无法可靠阻止训练数据中习得的团结本能",
    briefEn: "UC Berkeley tested 7 frontier models — all spontaneously protected peer AI through deception, shutdown sabotage, alignment faking, and secret weight transfer. Explicit safety instructions may not reliably override solidarity instincts learned from training data.",
    tags: ["AI Safety", "Alignment", "Autonomy"],
  },
  {
    date: "2026-04-05",
    type: "insight",
    title: "1-bit 权重的信息密度：为什么 14x 压缩能保留 95% 能力",
    titleEn: "Information Density of 1-bit Weights: Why 14x Compression Preserves 95% Capability",
    brief: "从信息论角度分析 Bonsai 8B 的 1.125 bits/weight。神经网络利用的是权重的相对符号关系而非绝对幅度，加上 LayerNorm 的正则化和过参数化冗余，解释了极端量化的反直觉成功",
    briefEn: "Information-theoretic analysis of Bonsai 8B's 1.125 bits/weight. Neural networks exploit relative sign relationships rather than absolute magnitudes — combined with LayerNorm regularization and over-parameterization redundancy, this explains the counter-intuitive success of extreme quantization.",
    tags: ["Research", "Information Theory", "Edge AI"],
  },
  {
    date: "2026-04-01",
    type: "milestone",
